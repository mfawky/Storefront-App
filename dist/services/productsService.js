...
var listAllProducts = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
var listSpecificProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var insertIntoProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newProduct, product, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, store.insert(newProduct)];
            case 1:
                product = _a.sent();
...
var editProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newProduct, product, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, store.edit(newProduct, +req.params.id)];
            case 1:
                product = _a.sent();
                res.json(product);
                return [3 /*break*/, 3];
...
var removeFromProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
